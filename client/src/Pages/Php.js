...
class App extends Component {
  ...
  getData = () => {
    axios
      ...
      .then((response) => {
        const data = response.data.filter((x) => x.technology === "Php");
        console.log(data);
    ...
    return (
      <div>
        ...
        <Link to="/Project_php" className="button">
          <Button variant="info">Php</Button>
        </Link>
        <Link to="/Project_mern" className="button">
          <Button variant="outline-info">MERN</Button>
        </Link>
        <Link to="/Achivements_ml" className="button">
